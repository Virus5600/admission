		...
		<div class="card">
			<div class="card-block" style="padding: 0px 15px;">
				<div class="card-title-block" style="margin-bottom: 5px;">
					<h3 class="title" style="margin: 5px; font-weight: 700; font-size: 1.3rem">List of students (For Approval)</h3>
				</div>
			</div>
		</div>
	</div>
            ...
            <div class="modal-footer" style="padding: 8px 0px 8px 0px;">
            	<div class="row">
	                <div class="col-md-12">
	                    ...
	                    <button class="float-right mr-2 buttgreen" id="btnapproverequirement"><i class="fa fa-thumbs-up"></i>&nbsp;Approve</button>
	                </div> 
            	</div>
            </div>
        </div>
            ...
            <div class="modal-body">
	        	<div class="row">
	        		<div class="col-md-12">
	  					...
	  					<textarea class="inputform" id="txtstuddenyremarks" name="txtstuddenyremarks" maxlength="500" placeholder="Option maximum of 500" style="height: 100px"></textarea>
	                </div>
	            </div>
        	</div>
        	<div class="modal-footer" style="padding: 8px 0px 8px 0px;">
