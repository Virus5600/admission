		...
		<div class="card">
			<div class="card-block" style="padding: 0px 15px;">
				<div class="card-title-block" style="margin-bottom: 5px;">
					<h3 class="title" style="margin: 5px; font-weight: 700; font-size: 1.3rem">Student Reports</h3>
				</div>
			</div>
		</div>
	</div>
				...
				<table class="table table-hover">
					<thead>
						<tr>
							...
							<th style="width: 10%; white-space: nowrap;">GENDER</th>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg" style="max-width: 650px;">
        <div class="modal-content">
            <div class="modal-header" style="background: #3a4651 !important;">
                <h4 class="modal-title text-white"><b>Student Information</b></h4>
            </div>
            <div class="modal-body" style="padding-bottom: 0px;">
            	...
            	<div id="bodystudentdet">
                	<div class="row mb-3">
	                    ...
	                    <div class="col-md-7 mb-1">
	                        <label class="control-label studproflabel">Guardian's Name:&nbsp;</label> 
